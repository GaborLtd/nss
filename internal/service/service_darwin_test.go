...
func TestRenderLaunchdPlistUsesAbsoluteExecutableAndLogs(t *testing.T) {
	...
	for _, expected := range []string{"com.gaborltd.nssd", "/Users/test/.local/bin/nssd", "<string>serve</string>", "<string>Background</string>", "<string>Aqua</string>", "nssd.stdout.log", "nssd.stderr.log"} {
